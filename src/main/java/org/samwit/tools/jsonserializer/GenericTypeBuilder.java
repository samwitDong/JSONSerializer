...
/**
 * A helper for building quickly the generic types of a particular generic
 * definition
 * 
 * @author samwitDong
 *
...
public class GenericTypeBuilder {
    ...
    /**
     * Changed to a generic-parameterized type with the rawType and the
     * typeParameters
     * 
     * @param rawType
     *            , any type that has at least one type parameter such as
     *            Collection<T>, Comparator<T> and etc.
     ...
     *            , the component type which could be a generic type or not
     * @param dimension
     *            , the array dimension, should be no less than 1
     * @return this object
     */
    ...
    /**
     * To create a new GenericTypeBuilder with a specified rawType and this
     * object as the only type parameter
     * 
     * @param rawType
    ...
    /**
     * To create a new GenericTypeBuilder with a specified array dimension and
     * this object as the component type
     * 
     * @param dimension
     * @return a new GenerictypeBuilder
     */
    public GenericTypeBuilder deriveGenericArrayType(int dimension) {
        if (dimension < 1) {
            throw new IllegalArgumentException("Invalid value of dimension (ought to be no less than 1): dimension = "
                    + dimension);
        }

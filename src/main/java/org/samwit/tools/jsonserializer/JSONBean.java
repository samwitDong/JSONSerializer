...
/**
 * Grant your data object the ability of being serialized into a JSON and
 * deserialized from a JSON by extending this abstract class
 * 
 * @author samwitDong
 *
 */
public abstract class JSONBean {
     ...
     * @param jsonString
     * @param pType
     *            represents the actual value of generic type parameters
     */
    ...
    private Object readObject(Type gType, Object object) {
        ...
        if (clazz.isArray()) {
            Type type = (gType instanceof GenericArrayType) ? ((GenericArrayType) gType).getGenericComponentType()
    ...
    private Object readCollection(Class<?> colClass, Type gType, JSONArray components) {
        ...
        Type componentGenericType = (gType instanceof ParameterizedType) ? ((ParameterizedType) gType)
                .getActualTypeArguments()[0] : Object.class;
    ...
    private Object readMap(Class<?> mapCls, Type gType, JSONObject jsonObject) {
        ...
        Type keyType = (gType instanceof ParameterizedType) ? ((ParameterizedType) gType).getActualTypeArguments()[0]
                : Object.class;
        Type valueType = (gType instanceof ParameterizedType) ? ((ParameterizedType) gType).getActualTypeArguments()[1]
                : Object.class;
    ...
    private Type getStandardGenericType(Type gType, HashMap<String, Type> typeParamsRef) {
        ...
        if (gType instanceof GenericArrayType) {
            ...
            gaTypeTarget.setGenericComponentType(getStandardGenericType(
                    ((GenericArrayType) gType).getGenericComponentType(), typeParamsRef));
            return gaTypeTarget;
        }
